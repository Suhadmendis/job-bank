...
<html>
    <head>
        <title>JobBankSystem index Page</title>
        <meta name="viewport"http-equiv="Content-Type" content="text/html; charset=UTF-8" content="width=device-width, initial-scale=1.0">
      
       


        <!--- template code --->
        <link href="asset/_css/bootstrap.css" rel="stylesheet" type="text/css" media="all"/>
        <link href="asset/_css/style.css" rel="stylesheet" type="text/css" media="all" />
        <link href="asset/_css/font-awesome.css" rel="stylesheet">
        <!--css-->
        ...
        <script src="asset/_js/jquery.min.js"></script>
        <link href='asset/fonts.googleapis.com/css?family=Cagliostro' rel='stylesheet' type='text/css'>
        <link href='asset/fonts.googleapis.com/css?family=Open+Sans:400,800italic,800,700italic,700,600italic,600,400italic,300italic,300' rel='stylesheet' type='text/css'>
        <!--search jQuery-->
        <script src="asset/_js/main.js"></script>
        <!--search jQuery-->
        <script src="asset/_js/responsiveslides.min.js"></script>
        <script>
            $(function () {
        ...
        <!--mycart-->
        <script type="text/javascript" src="asset/_js/bootstrap-3.1.1.min.js"></script>
        <!-- cart -->
        <script src="asset/_js/simpleCart.min.js"></script>
        <!-- cart -->
        <!--start-rate-->
        <script src="asset/_js/jstarbox.js"></script>
        <link rel="stylesheet" href="asset/_css/jstarbox.css" type="text/css" media="screen" charset="utf-8" />
        ...
        <div class="header">
            <div class="header-top">
                <div class="container">
                    ...
                    <div class="top-right">
                        <ul>
                            <li><a href="view/checkout.php">Checkout</a></li>
                            <li><a href="view/login.php">Login</a></li>
                            <li><a href="view/registered.php"> Create Account </a></li>
                        </ul>
                    </div>
                ...
                <div class="container">
                    <div class="logo-nav">
                        <div class="logo-nav-left">
                            <h1><a href="index.html">University Job Bank <span>Focus your Destination</span></a></h1>
                        </div>
                            ...
                            <nav class="navbar navbar-default">
                                ...
                                <div class="collapse navbar-collapse" id="bs-megadropdown-tabs">
                                    <ul class="nav navbar-nav">
                                        ...
                                        <!-- Mega Menu -->
                                        <li class="dropdown">
                                            <a href="#" class="dropdown-toggle" data-toggle="dropdown">Software Engineer<b class="caret"></b></a>
                                            <ul class="dropdown-menu multi-column columns-3">
                                                <div class="row">
                                                    <div class="col-sm-3  multi-gd-img">
                                                        <ul class="multi-column-dropdown">
                                                            <h6>Web Designing</h6>
                                                            <li><a href="view/job.php">Php</a></li>
                                                            <li><a href="view/job.php">Java Web/Jsp</a></li>
                                                            <li><a href="view/job.php">Android</a></li>
                                                            <li><a href="view/job.php">Groovy</a></li>
                                                            <li><a href="view/job.php">C++</a></li>
                                                    ...
                                                    <div class="col-sm-3  multi-gd-img">
                                                        <ul class="multi-column-dropdown">
                                                            ...
                                                            <h6>other</h6>
                                                            <li><a href="view/job.php">Data Entry</a></li>
                                                            <li><a href="view/job.php">Security</a></li>
                                                            <li><a href="view/job.php">Analysis</a></li>
                                                            <li><a href="view/job.php">Validators</a></li>

                                                        </ul>
                                                    </div>
                                                    <div class="col-sm-3  multi-gd-img">
                                                        <a href="view/job.php"><img src="images/sw1.jpg" alt=" "/></a>
                                                    </div> 
                                                    <div class="col-sm-3  multi-gd-img">
                                                        <a href="products.html"><img src="images/sw2.jpg" alt=" "/></a>
                                                    </div>
                                                    <div class="clearfix"></div>
                                                </div>
                                            </ul>
                                            ...
                                            <ul class="dropdown-menu multi-column columns-3">
                                                <div class="row">
                                                    <div class="col-sm-3  multi-gd-img">
                                                        <ul class="multi-column-dropdown">
                                                            <h6>Government</h6>
                                                            <li><a href="view/job.php">Manager</a></li>
                                                            <li><a href="view/job.php">Managment Assistent</a></li>
                                                            <li><a href="view/job.php">Chief Accountent</a></li>
                                                            <li><a href="view/job.php">Accountent</a></li>
                                                            <li><a href="view/job.php">other</a></li>
                                                    ...
                                                    <div class="col-sm-3  multi-gd-img">
                                                        <a href="view/job.php"><img src="images/woo3.jpg" alt=" "/></a>
                                                    </div> 
                                                    <div class="col-sm-3  multi-gd-img">
                                                        <a href="view/job.php"><img src="images/woo4.jpg" alt=" "/></a>
                                                    </div>
                                                    <div class="clearfix"></div>
                                                </div>
                                            </ul>
...
<!--                            <ul class="cd-header-buttons">
                        ...
                        <div class="header-right2">
                            <div class="cart box_1">
                                ...
                                <p><a href="javascript:;" class="simpleCart_empty">Empty</a></p>
                                <div class="clearfix"> </div>
                            </div>	
                        </div>
                        <div class="clearfix"> </div>
        ...
        <div class="banner-w3">
            ...
            <link href="asset/_css/coreSlider.css" rel="stylesheet" type="text/css">
            <script src="asset/_js/coreSlider.js"></script>
            <script>
            $('#example1').coreSlider({
                pauseOnHover: false,
                interval: 3000,
        ...
        <div class="content">
                ...
                <div class="container">
                    <div class="col-md-6 ban-bottom">
                        <div class="ban-top">
                            ...
                            <div class="ban-text">
                                <h4>Interview Questionaire</h4>
                            </div>
                            <div class="ban-text2 hvr-sweep-to-top">
                                <h4>with <span>General Knowledge</span></h4>
                            </div>
                        </div>
                    </div>
            ...
            <div class="accessories-w3l">
                <div class="container">
                    <h3 class="tittle">Are you ready?</h3>
